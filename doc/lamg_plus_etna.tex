...
PETSc GAMG, CMG) are invoked as subprocesses from the same harness; we report end-to-end
wall-clock time including startup, matching the methodology of \cite{gks2023}.
