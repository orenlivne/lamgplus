...
variant is publicly distributed; we therefore reimplemented it faithfully (validated to reproduce
its published operator complexities and $15$--$30$-iteration range) and ran all three robust
