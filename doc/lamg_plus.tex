...
\headers{LAMG+: Robust Lean Algebraic Multigrid}{O. E. Livne}
...
\bibitem{gks2023} Y.~Gao, R.~Kyng, and D.~A.~Spielman, \emph{AC($k$): Robust solution of
Laplacian equations by randomized approximate Cholesky factorization}, SIAM J.\ Sci.\ Comput.\
\textbf{48}(3), A1643--A1684, 2026 (the \texttt{approxchol\_lap2} solver in Laplacians.jl).
